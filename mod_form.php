...
class mod_learningmap_mod_form extends moodleform_mod {
    ...
    public function definition(): void {
        ...
        // Auto mode toggle: when enabled, nodes are generated from course activities per user.
        $mform->addElement('advcheckbox', 'automode', get_string('automode', 'learningmap'));
        $mform->setType('automode', PARAM_INT);
        $mform->addHelpButton('automode', 'automode', 'learningmap');
