...
$string['automode'] = 'Auto-generate nodes from course activities';
$string['automode_help'] = 'When enabled, places are generated automatically per user based on visible course activities. Manual editor placement and paths are ignored.';
